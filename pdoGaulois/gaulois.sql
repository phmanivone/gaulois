...
-- Listage de la structure de la table gaulois_dl12. autoriser_boire
...
-- Listage des données de la table gaulois_dl12.autoriser_boire : ~40 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. bataille
...
-- Listage des données de la table gaulois_dl12.bataille : ~15 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. boire
...
-- Listage des données de la table gaulois_dl12.boire : ~28 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. casque
...
-- Listage des données de la table gaulois_dl12.casque : ~15 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. composer
...
-- Listage des données de la table gaulois_dl12.composer : ~25 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. ingredient
...
-- Listage des données de la table gaulois_dl12.ingredient : ~26 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. lieu
...
-- Listage des données de la table gaulois_dl12.lieu : ~18 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. personnage
...
-- Listage des données de la table gaulois_dl12.personnage : ~42 rows (environ)
...
INSERT INTO `personnage` (`id_personnage`, `nom_personnage`, `adresse_personnage`, `image_personnage`, `id_lieu`, `id_specialite`) VALUES
	...
	(23, 'Zérozérosix', 'Prison', 'indisponible.jpg', 9, 14),
	...
	(47, 'Champdeblix', 'Ferme Hantassion', 'indisponible.jpg', 6, 12);
/*!40000 ALTER TABLE `personnage` ENABLE KEYS */;

-- Listage de la structure de la table gaulois_dl12. potion
...
-- Listage des données de la table gaulois_dl12.potion : ~15 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. prendre_casque
...
-- Listage des données de la table gaulois_dl12.prendre_casque : ~18 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. specialite
...
-- Listage des données de la table gaulois_dl12.specialite : ~17 rows (environ)
...
-- Listage de la structure de la table gaulois_dl12. type_casque
...
-- Listage des données de la table gaulois_dl12.type_casque : ~4 rows (environ)
